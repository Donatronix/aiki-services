    ...
    <nav>
        <div class="nav-wrapper">
            ...
            <a href="javascript:void(0)" class="brand-logo">
                <span class="icon">
                            <img class="light-logo" src="{{ asset('pages/assets/images/logo-light-icon.png') }}">
                            <img class="dark-logo" src="{{ asset('pages/assets/images/logo-icon.png') }}">
                        </span>
                <span class="text">
                            <img class="light-logo" src="{{ asset('pages/assets/images/logo-light-text.png') }}">
                            <img class="dark-logo" src="{{ asset('pages/assets/images/logo-text.png') }}">
                        </span>
            </a>
            <!-- ============================================================== -->
            <!-- Logo you can find that scss in header.scss -->
            ...
            <ul class="right">
                    ...
                    <ul id="msg_dropdown" class="mailbox dropdown-content">
                        ...
                        <li>
                            <div class="message-center">
                                ...
                                <a href="#">
                                    <span class="user-img">
                                                    <img src="{{ asset('pages/assets/images/users/1.jpg') }}" alt="user" class="circle">
                                ...
                                <a href="#">
                                    <span class="user-img">
                                                    <img src="{{ asset('pages/assets/images/users/2.jpg') }}" alt="user" class="circle">
                                ...
                                <a href="#">
                                    <span class="user-img">
                                                    <img src="{{ asset('pages/assets/images/users/3.jpg') }}}}" alt="user" class="circle">
                                ...
                                <a href="#">
                                    <span class="user-img">
                                                    <img src="{{ asset('pages/assets/images/users/4.jpg') }}" alt="user" class="circle">
                ...
                <li>
                    <a class="dropdown-trigger" href="javascript: void(0);" data-target="user_dropdown">
                        <img src="{{ auth()->user()->avatar }}" alt="user" class="circle profile-pic"></a>
                    <ul id="user_dropdown" class="mailbox dropdown-content dropdown-user">
                        <li>
                            <div class="dw-user-box">
                                <div class="u-img"><img src="{{ asset('pages/assets/images/users/2.jpg') }}" alt="user"></div>
                                <div class="u-text">
