...
<html>
    ...
    <head>
        ...
        <!-- This page CSS -->
        <link href="{{ asset('pages/dist/css/pages/data-table.css') }}" rel="stylesheet">
    ...
    <body>
            ...
            <div class="page-wrapper">
                ...
                <div class="page-titles">
                    <div class="d-flex align-items-center">
                        <h5 class="font-medium m-b-0">Assessment Questions</h5>
        ...
        <script src="{{ asset('pages/dist/js/pages/datatable/datatable-basic.init.js') }}"></script>
    </body>
